...
namespace WebApi.Models
{
    public class Utils
    {
        ...
        public Utils()
        {
            ...
            //_mongoTimeZoneCollection;
            //_mongoCountryCollection;
            //_mongoStateCollection;
            //_mongoCountyCollection;
            //_mongoCityCollection;
            //_mongoZipCodeCollection;
            //_mongoAreaCodeCollection;
            _mongoEventCollection = _mongoDatabase.GetCollection<Event>("Events");
            //_mongoLocationCollection = _mongoDatabase.GetCollection<GPS>("Locations");
            //_mongoUserCollection;
            //_mongoNameCollection;
            //_mongoFemaleNameCollection;
            //_mongoMaleNameCollection;
            //_mongoLastNameCollection;
            //_mongoStreetNameCollection;
            //_mongoTNCCollection;
        }
        ...
        public User LoginUser(string userEmail, string userPassword, double userLatitude, double userLongitude)
        {
            try
            {
                ...
                if (encryptUser)
                {
                    userEmailUserName = EncryptString(_parsedEmailComponents[0], Constants.EncryptionKey.ToString());
                    userEmailDomain = EncryptString(_parsedEmailComponents[1], Constants.EncryptionKey.ToString());
                }
                ...
                if (_users.Count > 0)
                {
                    ...
                    if (encryptUser)
                    {
                        userPassword = EncryptString(userPassword.Trim(), _users[0]._id.ToString());
        ...
        public User EncryptUserData(User _user)
        {
            ...
            _user.Pwd = EncryptString(_user.Pwd.ToLower(), _user._id.ToString());

            _user.FirstName = EncryptString(UppercaseFirstLetter(_user.FirstName), _user._id.ToString());
            _user.LastName = EncryptString(UppercaseFirstLetter(_user.LastName), _user._id.ToString());

            _user.Contact.Address.Address1 = EncryptString(_user.Contact.Address.Address1, _user._id.ToString());
            _user.Contact.Address.Address2 = EncryptString(_user.Contact.Address.Address2, _user._id.ToString());
        ...
        {
            // Encrypt needed fields
            _user.Pwd = DecryptString(_user.Pwd.ToLower(), _user._id.ToString());

            _user.FirstName = DecryptString(UppercaseFirstLetter(_user.FirstName), _user._id.ToString());
            _user.LastName = DecryptString(UppercaseFirstLetter(_user.LastName), _user._id.ToString());

            _user.Contact.Address.Address1 = DecryptString(_user.Contact.Address.Address1, _user._id.ToString());
            _user.Contact.Address.Address2 = DecryptString(_user.Contact.Address.Address2, _user._id.ToString());
        ...
        public string SendEmail(Message _message)
        {
            ...
            try
            {
                ...
                smtp.Credentials = new NetworkCredential(ConfigurationManager.AppSettings["LoginUserName"], ConfigurationManager.AppSettings["LoginPassword"]);
        ...
        #region Properties
            ...
            IMongoCollection<TimeZone> _mongoTimeZoneCollection;
            ...
            IMongoCollection<NameFemale> _mongoFemaleNameCollection;
            IMongoCollection<NameMale> _mongoMaleNameCollection;
