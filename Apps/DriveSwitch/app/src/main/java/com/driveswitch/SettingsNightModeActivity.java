...
public class SettingsNightModeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings_night_mode);
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                Utilities.logUserLocationAndValidateSubscription(SettingsNightModeActivity.this, myUser._id, Constants.EmptyObjectId, userLatitude, userLongitude);
                populateMyUser();
        ...
        // Set Gender listbox
        final Spinner staticSpinner = (Spinner) findViewById(R.id.inpNightmode);

        // Create an ArrayAdapter using the string array and a default spinner
        ArrayAdapter<CharSequence> staticAdapter = ArrayAdapter.createFromResource(this, R.array.list_nightmode, android.R.layout.simple_spinner_item);
        ...
        staticSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3)
            {
                ...
                // Save to preferences
                String preferenceValue = staticSpinner.getSelectedItem().toString();

                SharedPreferences.Editor editor = getSharedPreferences("NightMode", MODE_PRIVATE).edit();
                editor.putString("NightMode", preferenceValue);
                editor.commit();

                Utilities.setNightMode(preferenceValue);

                showProgress(false);

                Toast.makeText(SettingsNightModeActivity.this,"Nightmode set to " + preferenceValue, Toast.LENGTH_SHORT).show();
            }
    ...
    public void setNightmodeSelection()
    {
        SharedPreferences prefs = getSharedPreferences("NightMode", MODE_PRIVATE);
        String preferenceValue = prefs.getString("NightMode", null);

        if(preferenceValue != null) {
            ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.list_nightmode, android.R.layout.simple_spinner_item);
            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

            Spinner mSpinner = (Spinner) findViewById(R.id.inpNightmode);
            mSpinner.setAdapter(adapter);

            if (!preferenceValue.equals(null)) {
                int spinnerPosition = adapter.getPosition(preferenceValue);
