...
public class AdministrationMessagesActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_administration_messages);
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(android.location.Location location) {
                ...
                Utilities.logUserLocationAndValidateSubscription(AdministrationMessagesActivity.this, myUser._id, Constants.EmptyObjectId, userLatitude, userLongitude);
                populateMyUser();
