...
public class ContactActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mContactButton = (Button) findViewById(R.id.btnSubmit);
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                Utilities.logUserLocationAndValidateSubscription(ContactActivity.this, myUser._id, Constants.EmptyObjectId, userLatitude, userLongitude);
            }
    ...
    {
        TextView msgResult = (TextView) findViewById(R.id.textMessageResult);
        EditText msgBody = (EditText) findViewById(R.id.textMessage);
        ...
        myMessage.UserId = myUser._id;

        myMessage.Subject = Utilities.urlEncode("User contact request");

        myMessage.Body = Utilities.urlEncode(msgBody.getText().toString());
        //myMessage.Body = Utilities.urlEncode("Is this stuff close to being ready for production?");

        if(myMessage.Body == "") {
            msgResult.setText("Please type your message below.");
            showProgress(false);
            return;
        }

        myMessage.Location.UIScreen = this.getClass().toString();
        myMessage.Location.UserId = myUser._id;
        myMessage.Location.TNCId = "";
        myMessage.Location.Latitude = userLatitude;
        myMessage.Location.Longitude = userLongitude;

        String deliveryReceipt = Utilities.sendMessage(myMessage);
        //if(deliveryReceipt == "Message sent")
            deliveryReceipt = "Thank you for contacting us. We will reply as soon as possible.";

        msgResult.setText(deliveryReceipt);
        msgBody.setText("");
