...
public class AdministrationNotificationsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_administration_notifications);
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(android.location.Location location) {
                ...
                Utilities.logUserLocationAndValidateSubscription(AdministrationNotificationsActivity.this, myUser._id, Constants.EmptyObjectId, userLatitude, userLongitude);
                populateMyUser();
